...
const ModalContent = (props) => {
	...
	const { children, isConfirmationPopup = true, title, description, handleAcceptFunction, handleCancelFunction } = props;
	...
	return (
		<div onClick={(event) => {event.stopPropagation()}} className="modal-content">
			<div className="modal-content__text-wrap">
				...
				{
					description && <p className="modal-content__description">{description}</p>
				}
			</div>
			{
				isConfirmationPopup ? (
